...
setwd("/users/decler/desktop/ucberkeley/assweek10")
# ---- Set Up ----
# Import libraries
  ...
  ui <- fluidPage(
    ...
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        selectInput(inputId = "subset_income", label  = "Select Income Group", 
                    choices = unique(income$income), c("<=50K","50K Only")),
        # Interactive piece 2: inputId = "set_yaxis"
        selectInput(inputId = "set_yaxis", label = "Select Y variable", 
